...
| 空の出力がありました | 手順 11 を省略して、に進みます ,手順 12。 
...
| ノード 1 またはノード 2 | - 完了しました ,手順 23 および ,手順 24。 


| ノード 1 とノード 2 ではありません | に進みます ,手順 24。 
|===
...
| SAN が設定されている | に進みます ,手順 26。 


| SAN が設定されていません | に進みます ,手順 29。 
|===
