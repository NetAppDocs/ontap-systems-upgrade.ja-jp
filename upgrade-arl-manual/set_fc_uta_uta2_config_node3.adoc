...
** node3 にカードポートまたはオンボードポートがない場合は、を省略します <<ノード 3 の UTA / UTA2 ポートを確認して設定してください>>をクリックし、 _Install に戻り、 node3 をブートして、で再開します link:install_boot_node3.html#step7["手順 7"]。
