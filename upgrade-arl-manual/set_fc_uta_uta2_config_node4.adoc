...
完了する必要がある場合があります  FC ports on node4、  and configure UTA/UTA2 ports on node4、または両方のセクション。
...
システムに FC 構成がない場合は、このセクションをスキップしてかまいません。システムにオンボード UTA / UTA2 ポートまたは UTA / UTA2 アダプタが搭載されている場合は、で設定します  and configure UTA/UTA2 ports on node4。
...
| 元のノードでキャプチャしたのと同じです | に進みます ,手順 11。 


| 元のノードでキャプチャしたものとは異なります | に進みます ,手順 8.。 
|===
...
| ストレージディスクがあります  a| 
** に進みます  and configure UTA/UTA2 ports on node4 ノード 4 に UTA / UTA2A カードまたは UTA / UTA2 オンボードポートがある場合
...
** に進みます  and configure UTA/UTA2 ports on node4 ノード 4 に UTA / UTA2 カードまたは UTA / UTA2 オンボードポートがある場合
