...
+
詳細については、link:other_references.html["参考資料"] を参照して _Network Management_ または _ONTAP 9 Command reference_ にリンクし、_Configuring failover settings on a LIF_ に進んでください。
