...
+
詳細については、を参照してください link:other_references.html["参考資料"] ONTAP 9 ネットワーク管理ガイドまたは ONTAP 9 コマンド：マニュアルページリファレンスにリンクするには、 LIF_Configuring failover settings on a LIF_.
