...
| SAN 環境の場合 | - 完了しました <<ステップ6,手順 6>> をクリックして、セクションに移動します link:move_nas_lifs_node2_from_node3_node4_verify_san_lifs_node4.html["node2 によって所有されている NAS データ LIF を node3 から node4 に移動し、 node4 にある SAN LIF を確認します"]。 
