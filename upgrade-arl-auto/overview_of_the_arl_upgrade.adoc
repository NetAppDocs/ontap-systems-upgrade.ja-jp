...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["2 つ"]link:relocate_non_root_aggr_and_nas_data_lifs_node1_node2.html["ステージ 2 ：移行してノード 1 を撤去"]
[role="quick-margin-para"]
