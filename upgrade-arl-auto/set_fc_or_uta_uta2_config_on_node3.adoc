...
** ノード3にUTA / UTA2カードまたはUTA / UTA2オンボードポートがない場合は、この手順をスキップし<<ノード 3 の UTA / UTA2 ポートを確認して設定してください>>てに進みますlink:reassign-node1-disks-to-node3.html["ノード1のディスクをノード3に再割り当て"]。
