...
ストレージディスクを搭載したシステムをアップグレードする場合、ノード3にオンボードのFCポート、オンボードUTA / UTA2ポート、またはUTA / UTA2カードがない場合は、に進みます。link:reassign-node1-disks-to-node3.html["ノード1のディスクをノード3に再割り当て"]
...
. 次のいずれかを実行します。
+
** node3にUTA/UTA2カードまたはUTA/UTA2オンボードポートがある場合は、<<check-config-uta-uta2-node3,ノード 3 の UTA / UTA2 ポートを確認して設定してください>>に進みます。
** node3にUTA/UTA2カードまたはUTA/UTA2オンボードポートがない場合は、<<check-config-uta-uta2-node3,ノード 3 の UTA / UTA2 ポートを確認して設定してください>>をスキップしてlink:reassign-node1-disks-to-node3.html["ノード1のディスクをノード3に再割り当て"]に進んでください。
...
== ステップ2：node3のUTA/UTA2ポートを確認して設定する
...
. 実行してノードをブートメニューで起動します。 `boot_ontap menu` 。


.次の手順
* AFF A800システムにアップグレードする場合は、link:reassign-node1-disks-to-node3.html#auto_check3_step9["ノード1のディスクをノード3に再割り当て（手順9）"] 。
