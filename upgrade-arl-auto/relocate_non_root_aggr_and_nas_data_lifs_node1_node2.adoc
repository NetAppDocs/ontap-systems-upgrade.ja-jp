...
summary: ONTAP 9.5 を実行しているコントローラを 9.7 にアップグレードする場合は、「 system controller replace 」コマンドを使用して、ルート以外のアグリゲートと NAS データ LIF をノード 1 からノード 2 に移動し、ノード 1 のリソースをノード 3 に移動します。 
---
