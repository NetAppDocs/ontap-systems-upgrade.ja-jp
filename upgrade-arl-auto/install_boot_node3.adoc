...
.次の手順
* FCまたはUTA/UTA2構成のシステムをお持ちの場合は、link:set_fc_or_uta_uta2_config_on_node3.html["ノード3でFCまたはUTA/UTA2構成を設定する"] 。
* FCまたはUTA/UTA2構成がない場合は、link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["ノード1のディスクをノード3に再割り当てする"]ノード3がノード1のディスクを認識できるようにする。
* MetroCluster構成の場合、link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["ノード1のディスクをノード3に再割り当てする"] 。
