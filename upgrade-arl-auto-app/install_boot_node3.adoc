...
+
FC または UTA / UTA2 設定がない場合は、を実行します link:set_fc_or_uta_uta2_config_node4.html#auto_check_4_step15["ノード 4 の UTA / UTA2 ポートの確認と設定、手順 15"] ノード4がノード2のディスクを認識できるようにします。
