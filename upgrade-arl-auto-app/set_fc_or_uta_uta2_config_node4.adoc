...
summary: system controller replace コマンドを使用して ONTAP 9.8 以降を実行しているコントローラをアップグレードする際に、node4 のオンボード FC ポート、UTA および UTA2 ポート、または UTA および UTA2 カードを設定します。 
---
...
[NOTE]
====
node4 にオンボード FC ポート、オンボード UTA/UTA2 ポート、または UTA/UTA2 カードがなく（たとえば、ONTAP 9.15.1 以降で導入された AFF および FAS システム）、ストレージディスクを搭載したシステムをアップグレードする場合は、link:reassign-node2-disks-to-node4.html["ノード2のディスクをノード4に再割り当てします。"] にスキップできます。
...
.このタスクについて
システムにFC構成がない場合は、このセクションをスキップできます。システムにオンボードの UTA/UTA2 ポートまたは UTA/UTA2 アダプタがある場合は、<<check-config-uta-uta2-node4,ノード 4 の UTA / UTA2 ポートを確認して設定してください>>で設定します。
...
+
** node4にUTA/UTA2カードまたはUTA/UTA2オンボードポートが搭載されている場合は、<<check-config-uta-uta2-node4,ノード 4 の UTA / UTA2 ポートを確認して設定してください>>に進みます。
** ノード4にUTA/UTA2カードまたはUTA/UTA2オンボードポートがない場合は、「ノード4のUTA/UTA2ポートの確認と設定」をスキップして、link:reassign-node2-disks-to-node4.html["ノード2のディスクをノード4に再割り当てします。"] 。
...
== ステップ2：node4のUTA/UTA2ポートを確認して設定する
