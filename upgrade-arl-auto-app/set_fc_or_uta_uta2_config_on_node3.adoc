...
node3 にオンボード FC ポート、オンボード UTA/UTA2 ポート、または UTA/UTA2 カードがなく（たとえば、ONTAP 9.15.1 以降で導入された AFF および FAS システム）、ストレージディスクを搭載したシステムをアップグレードする場合は、link:reassign-node1-disks-to-node3.html["ノード1のディスクをノード3に再割り当て"] にスキップできます。
...
| UTA/UTA2 カードまたは UTA/UTA2 オンボード ポートを搭載 | <<check-config-uta-uta2-node3,ノード 3 の UTA / UTA2 ポートを確認して設定してください>>に移動します 
