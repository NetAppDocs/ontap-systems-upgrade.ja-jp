...
^4^コントローラのアップグレードでサポートされているONTAP のバージョンを確認します。
...
| AFF8060の場合 | 9.8P13以降のパッチ | AFF A900 の略 | 9.10.1 以降 


| AFF8080 | 9.8P10以降のパッチ | AFF A900 の略 | 9.10.1 以降 


| FAS8060 | 9.8P13以降のパッチ | FAS9500 | 9.10.1P3以降 


| FAS8080 | 9.8P12以降のパッチ | FAS9500 | 9.10.1P3以降 
|===
