...
+
MetroCluster IP構成のアップグレードについては、link:other-references.html["参考資料"]を参照して『MetroCluster Upgrade and Expansion』にアクセスしてください。
...
^4^次の表は、コントローラのアップグレードの組み合わせでサポートされているONTAPバージョンを示しています。
...
.次の手順
この ARL 手順を使用するかどうかを決定した後、link:required_tools_and_documentation.html["必要なツールとドキュメント"]について学習します。
