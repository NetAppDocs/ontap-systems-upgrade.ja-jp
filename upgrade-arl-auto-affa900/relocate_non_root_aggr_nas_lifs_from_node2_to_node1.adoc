...
summary: node2 を AFF A900 コントローラモジュールと NVS に交換する前に、 node2 に所有されているルート以外のアグリゲートを node1 に再配置する必要があります。 
---
...
[role="lead"]
node2 を AFF A900 コントローラモジュールと NVS に交換する前に、 node2 に所有されているルート以外のアグリゲートを node1 に再配置する必要があります。
