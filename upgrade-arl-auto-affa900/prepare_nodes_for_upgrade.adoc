...
を参照してください link:other_references.html["参考資料"] NLFを取得できる_ NetApp Support Site _にリンクします。NLFは、_ソフトウェアライセンス_の_ My Support_セクションで入手できます。必要なNLFがサイトにない場合は、NetAppの営業担当者にお問い合わせください。
