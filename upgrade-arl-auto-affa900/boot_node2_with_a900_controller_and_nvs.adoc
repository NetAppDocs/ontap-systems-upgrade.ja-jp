...
. ノードはブートメニューで停止します。「 22/7 」と入力し、非表示オプション「 boot_after_controller_replacement 」を選択します。AFF A700またはFAS9000 node1のディスクをAFF A900またはFAS9500 node1に再割り当てするには、プロンプトでnode2の実際のノード名を入力します。次の例を参考にしてください。
+
[listing]
----
