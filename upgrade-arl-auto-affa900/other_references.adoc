...
summary: アップグレードのサポートに必要な参照コンテンツおよび Web サイトへのリンク。 
---
= 参考資料
:hardbreaks:
:nofooter: 
...
| link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-affa900/index.html["「 system controller replace 」コマンドを使用して、 ONTAP 9.10.1 RC2 以降を実行する AFF A700 を AFF A900 にアップグレードします"^] | 「 system controller replace 」コマンドを使用して、 ONTAP 9.10.1 RC2 以降を実行する AFF A900 への AFF A700 の無停止アップグレードに必要なアグリゲートの再配置手順について説明します。 
