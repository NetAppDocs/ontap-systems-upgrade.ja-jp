...
AFF A250、AFF C250、AFF A800、またはAFF C800のアップグレードの場合のみ、既存のノード1の物理ポートを交換用のノード1にマッピングします。これは、既存のコントローラと交換用コントローラの間で物理ポートが変更されるためです。

それ以外のアップグレードでは、既存のノード1の物理ポートを交換用ノード1にマッピングする必要はありません。
