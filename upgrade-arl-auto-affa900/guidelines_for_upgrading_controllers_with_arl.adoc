...
新しいシャーシを含む完全なシステムとして新しいAFF A30、AFF A50、AFF A70、AFF、AFF A150、AFF A900、AFF A90 C30、AFF C60、AFF C80、FAS2820、またはFAS9500を受け取った場合は、「system controller replace」コマンドのリンクを参照しlink:other_references.html["参考資料"]て、ONTAP 9.8以降を実行しているコントローラハードウェアをアップグレードしてください。
