...
. （AFF A250およびAFF C250のアップグレードのみ）交換用コントローラモジュールのノード1をブートすると、次の警告が表示されます。
+
[listing]
----
*****************************************************
...
+
この警告は、構成に既存のコントローラのノード2が含まれているために表示されます。node2をアップグレードするまで、システムがブートするたびにが表示されます。これは想定される動作です。
