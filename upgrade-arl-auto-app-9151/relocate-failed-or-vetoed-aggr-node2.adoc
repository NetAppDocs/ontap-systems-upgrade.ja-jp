...
summary: 'ONTAP 9.15.1以降で導入されたコントローラへのアップグレード時に、 `system controller replace`コマンドを使用して、障害が発生した、または拒否されたアグリゲートを手動でnode2に再配置します。' 
---
...
.次の手順
失敗した、または拒否されたアグリゲートをノード2に移動した後、link:retire_node1.html["node1を撤去"]。
