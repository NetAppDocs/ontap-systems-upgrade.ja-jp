...
summary: 必要に応じて、ARLを使用して同一シャーシ内のコントローラモデルをアップグレードする場合、新しいコントローラモジュールをNVEまたはNAE用に構成してください。 
---
...
.次の手順
新しいコントローラモジュールでNetApp Volume or Aggregate Encryptionを設定した後、link:decommission-old-system.html["旧システムを廃止する"]。
