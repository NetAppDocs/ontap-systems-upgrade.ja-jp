...
[role="lead"]
交換用モジュールを搭載した Node2 の起動準備が完了しました。サポートされている交換モジュールは、link:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["サポートされるシステムマトリックス"] 。
