...
NOTE: アグリゲートの再配置を使用して、AFF A800をAFF A70またはAFF A90にアップグレードすることもできます。link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["詳細はこちら。"]です。
