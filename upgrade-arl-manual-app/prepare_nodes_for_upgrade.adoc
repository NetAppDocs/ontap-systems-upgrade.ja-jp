...
+
 `network interface revert`コマンドの詳細については、link:other_references.html["参考資料"]を参照して_ONTAP 9 Command reference_にリンクしてください。
...
+
リモート管理デバイス（この場合は SP）のネットワークパラメータを、元のシステムから新しいノード上の SP に再利用することもできます。SP の詳細については、link:other_references.html["参考資料"]を参照して_システム管理リファレンス_および_ONTAP 9 コマンドリファレンス_にリンクしてください。
...
+
AutoSupportの詳細については、link:other_references.html["参考資料"]を参照して、_System Administration Reference_および_ONTAP 9 Command reference_にリンクしてください。
