...
* link:other-references.html["参考資料"]を参照して、NetApp Support Siteにアクセスし、お使いのプラットフォームに必要なシステムファイルと正しいバージョンのONTAPをダウンロードしてください。
...
.次の手順
ネットブートの準備後、link:relocate_non_root_aggr_node1_node2.html["非ルートアグリゲートをnode1からnode2に再配置する"]。
