...
+
「 * Status Admin/Oper * 」列を参照して、停止している LIF がないかどうかを確認します。停止している LIF がある場合は、を参照してください link:troubleshoot_index.html["不具合のすす"] セクション。
...
| 2 ノードクラスタ | に進みます ,手順 6。 


| 3 つ以上のノードで構成されるクラスタ | に進みます ,手順 8。 
|===
