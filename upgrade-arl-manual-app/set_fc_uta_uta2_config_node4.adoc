...
summary: ONTAP 9.8以降を実行しているコントローラーの手動ARLアップグレード中に、node4オンボードFCポート、UTAおよびUTA2ポート、またはUTAおよびUTA2カードを設定します。 
---
...
.次の手順
node4でFCまたはUTA/UTA2構成を設定した後、link:map_ports_node2_node4.html["node2からnode4へポートをマッピングする"]。
