...
ストレージアグリゲートの再配置コマンドの詳細については、link:other_references.html["参考資料"]にアクセスして、_CLI を使用したディスクおよびアグリゲートの管理_および_ONTAP 9 コマンドリファレンス_にリンクしてください。
...
.次の手順
非ルート集約をノード2からノード3に移動した後、link:move_nas_lifs_node2_node3.html["ノード2が所有するNASデータLIFをノード3に移動します"]。
