...
---
= ストレージを移動してアップグレードする方法について説明します
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.次の手順
ストレージの移動によるアップグレードについて学んだ後、link:upgrade-prepare-when-moving-storage.html["アップグレードの準備をする"]。

.関連情報
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["ドライブシェルフに変換して、AFF A250をAFF A400にアップグレードします"]（非破壊的手順）
* link:convert-to-drive-shelf.html["AFF A150、AFF A220、またはFAS2820をドライブシェルフに変換してアップグレード"]（無停止手順）
