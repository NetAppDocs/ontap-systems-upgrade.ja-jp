...
[role="lead"]
AFF A150、AFF A220、またはFAS2820のnode1上のデータアグリゲート、イプシロン、および論理インターフェース（LIF）をnode4に移行します。
...
.次の手順
link:convert-node1-to-drive-shelf.html["node1をドライブシェルフに変換し、node3に接続します"]
