...
summary: ボリュームを移動してアップグレードする場合は、元のノードを準備し、新しいノードをクラスターに参加させます。ボリュームを新しいノードに移動し、LIFを構成して、元のノードをクラスターから削除します。ボリュームを移動してアップグレードすることは、無停止の手順です。 
---
= ボリュームの移動によるアップグレードについて
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.次の手順
ボリュームの移動によるアップグレードについて学んだ後、link:upgrade-prepare-when-moving-volumes.html["アップグレードの準備をする"]。
