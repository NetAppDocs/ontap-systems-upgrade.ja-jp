...
summary: アップグレードを完了するには、node3をnode4に接続し、node4のデータ論理インターフェイス（LIF）とデータアグリゲートをnode3に移行します。 
---
...
[role="lead"]
アップグレードを完了するには、node3をnode4に接続し、node4のデータ論理インターフェイス（LIF）とデータアグリゲートをnode3に移行します。
